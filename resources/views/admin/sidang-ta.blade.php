...
<div class="max-w-6xl mx-auto py-10 px-4">
    <h1 class="text-3xl font-bold text-blue-800 mb-6">Data Sidang Tugas Akhir</h1>
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse ($sidangTa as $item)
                    <tr class="hover:bg-gray-50">
                        ...
                        <!-- Status -->
                        <td class="px-4 py-3">
                            <form action="{{ route('admin.sidang-ta.status', $item->id) }}" method="POST" class="flex items-center gap-2">
                                @csrf
                                @method('PUT')
                                <select name="status"
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-5 text-center text-gray-400">Belum ada data.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
