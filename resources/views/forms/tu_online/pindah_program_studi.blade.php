...
@section('content')
    <div class="max-w-3xl mx-auto bg-white px-6 sm:px-10 lg:px-12 py-10 shadow-2xl rounded-3xl border border-gray-200">
        ...
        <form action="{{ route('pindah-program-studi.submit') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-y-6 md:gap-x-8">
            @csrf
            ...
            {{-- Program Studi Asal --}}
            <div>
                <label for="program_studi_asal" class="block text-sm font-medium text-gray-700 mb-1">Program Studi Asal</label>
                <select name="program_studi_asal" id="program_studi_asal"
                    class="w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    required>
                    <option value="" disabled selected>Pilih asal program studi</option>
            ...
            <div>
                <label for="program_studi_tujuan" class="block text-sm font-medium text-gray-700 mb-1">Program Studi Tujuan</label>
                <select name="program_studi_tujuan" id="program_studi_tujuan"
                    class="w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    required>
                    <option value="" disabled selected>Pilih tujuan program studi</option>
                    <option value="Arsitektur">Arsitektur</option>
                    <option value="Teknik Sipil">Teknik Sipil</option>
                    <option value="Teknik Elektro">Teknik Elektro</option>
                    <option value="Teknik Mesin">Teknik Mesin</option>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="alasan" id="alasan" rows="4"
                    class="w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    required placeholder="Tulis alasan Anda ingin pindah program studi..."></textarea>
            </div>
